      ...
      <div className="container mx-auto">
        <div className="container mx-auto bg-[#F0F0F0] rounded-2xl mt-12 sm:mt-16 py-12 sm:py-20 text-center shadow-md">
          ...
          >
            <Button
              size="lg"
              className="bg-[#323232] text-[#f0f0f0] font-semibold rounded-lg px-10 py-6 shadow-sm hover:bg-gray-100 hover:text-[#323232] transition-colors"
            >
              <svg
                width="30"
                height="30"
              ...
              >
                <path
                  ...
                  className="fill-[#f0f0f0] hover:fill-[#323232]"
                />
              </svg>
