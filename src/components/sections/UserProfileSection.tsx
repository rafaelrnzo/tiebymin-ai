...
const UserProfileSection: React.FC<UserProfileSectionProps> = ({
  ...
  return (
    <div className="bg-[#323232] xl:w-[500px] md:w-full md:h-[250px] xl:h-[700px] lg:h-full rounded-3xl p-5 text-[#f0f0f0] flex flex-col lg:flex-row md:flex-row items-center xl:flex-col gap-x-5 lg:mt-[60px] xl:mt-0">
