...
export default function PrepareFacePage() {
  ...
  return (
    <main className="min-h-screen bg-[url('/login-bg.png')] bg-gradient-to-br from-pink-200 via-pink-300 to-pink-400 flex items-center justify-center">
      <div className="mx-auto container w-full max-w-[85rem] flex flex-col lg:flex-row items-center justify-center">
        <div className="hidden lg:block w-full lg:flex-1 lg:max-w-[40%] lg:flex-shrink-0">
          <LeftSideSection
            currentStep={3}
